...
Based on this method, we propose 2 simple saillance models, one based on camera depth and distance to the center of the camera and a second one based a colorimetric saillance. An image with saillance based on distance to the center of the screen
